  ...
  render() {
    return (
      <div className='select'>
        <span
          className={this.state.selectedCountrie ? 'selectedCountrie' : ' '}
        >
          {this.state.searchTermCountrie}
        </span>
        <span className={this.state.selectedSport ? 'selectedSport' : ' '}>
          {' '}
          {this.state.searchTermSport}
        </span>
        <form>
          <div class='multiselect'>
            ...
            <data
              id='checkboxes'
              className={this.state.isShown ? 'show' : 'hide'}
            >
              <label for='1'>
                <input
                  id='1'
                  name='countrie1'
                  type='checkbox'
                  onChange={(e) => this.selectedCountrie(e)}
                />
                First checkbox
              </label>
              <label for='2'>
            ...
            >
              <label for='16'>
                <input
                  ...
                  name='sport1'
                  type='checkbox'
                  onChange={(e) => this.selectedSport(e)}
                />
                First checkbox
              </label>
              <label for='17'>
